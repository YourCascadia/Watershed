$(document).ready(function () {
    ...
    */
    ...
    (function ($) {
        $.fn.continueLoading = function (delay) {
            var speed =500;
    ...
    (function ($) {
        ...
        //PADDING
        var padding =12, margin = 12, docwidth = $("body").width(), docheight = $("body").height(), canvaswidth = docwidth - ((2 * padding) + (2 * margin)), canvasheight = docheight - ((2 * padding) + (2 * margin));
        ...
        var goldenratio = 1.61803399, a = canvaswidth / goldenratio, b = canvaswidth - a - 1, halfbuttonwidth = buttonwidth / 2, buttonPosRight = (canvaswidth + margin + padding - halfbuttonwidth), buttonPos33 = b + margin + padding - halfbuttonwidth, buttonPosLeft = margin + padding + 10; //initial location of button is buttonPos33;
        ...
        (function ($) { $.fn.canvasRight = function () { $(this).show(); $(this).animate({ width: a + "px" }); $(this).removeClass("expanded"); return true; }; })(jQuery);

        (function ($) { $.fn.canvasNone = function () {
        ...
        (function ($) {
            $.fn.buttonPosition = function (clicklr) {
                ...
                var leftclass = $("#button").hasClass("left"), middleclass = $("#button").hasClass("middle"), rightclass = $("#button").hasClass("right");
                if (mobile === false) { //if mobile is false (if it's in desktop mode);
                    ...
                    if (leftclass === true) {
                        ...
                        $(".profiletext").show(200); 
                        $(".profileinfo").show(200);
                        $("#pic").profilepic(200);
                        $("#pic").addClass("leftshadow", 500); 
                        $("#content").canvasRight();
                        $("#profile").canvasLeft();
                        $("#brightarrow").removeClass("bounceright");
                        $("#button").animate({ left: buttonPos33 }, function () { $(document).resizecontent();  $("#brightarrow").addClass("bounceright"); $("#bleftarrow").show(); $("#bleftarrow").addClass("bounceleft"); $("#buttonleft").show(); $("#button").addClass("rightshadow"); $("#button").removeClass("leftshadow"); });
                        window.location.hash = 'home';
                        clickedlr = "null";
                        leftclass = false;
                        middleclass = false;
                    ...
                    //middle button, left click //button moves to left
                        ...
                        $("#pic").profilesmall(500);
                        $("#button").removeClass("middle");
                        $("#button").addClass("left");
                        $("#content").canvasFull();
                        $("#bleftarrow").hide();
                        $("#brightarrow").removeClass("bounceright");
                        $("#button").animate({ left: buttonPosLeft }, function () { $(document).resizecontent();  $("#brightarrow").addClass("bounceright"); $("#buttonleft").hide(); $("#button").addClass("rightshadow"); $("#button").removeClass("leftshadow"); });
                    ...
                    //middle button, right click // button moves to right
                        ...
                        $("#brightarrow").hide();
                        $("#button").removeClass("rightshadow");
                        $("#button").animate({ left: buttonPosRight }, function () { $(document).resizecontent(); $("#buttonright").hide(); $("#button").addClass("leftshadow"); $("#buttonleft").show(); $("#buttonleft").addClass("white"); $("#bleftarrow").addClass("darkblue"); $("#bleftarrow").addClass("bounceleft"); });
                        window.location.hash = 'profile';
                        clickedlr = "null";
                        leftclass = false;
                        middleclass = false;
                    ...
                    //right button, left click //button moves to middle
                        ...
                        $("#bleftarrow").removeClass("darkblue");
                        $(document).reanimate();
                        $("#button").animate({ left: buttonPos33 }, function () { $(document).resizecontent(); $("#brightarrow").show(); $("#buttonright").show(); $("buttonright").show(); $("#buttonright").show(); $("#button").addClass("rightshadow"); $("#button").removeClass("leftshadow"); $("#bleftarrow").addClass("bounceleft"); $("#brightarrow").addClass("bounceright"); });
                        window.location.hash = 'home';
                        clickedlr = "null";
                        leftclass = false;
                        middleclass = false;
